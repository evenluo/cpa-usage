...
- [CPA data compatibility](docs/design/cpa-data-compatibility.md): supported producer fields, future-only observations, SQLite upgrades, rollup reconstruction, and release evidence boundaries.
