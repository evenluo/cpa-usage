...
- The [accounting-v2 extension](../design/usage-accounting-contract.md) preserves typed canonical/execution facts. Malformed extension fields retain a bounded invalid marker through projection and yield qualified accounting while the attempt and allowlisted legacy facts remain processable. This does not change malformed base-envelope isolation or the destructive-pop boundary.
