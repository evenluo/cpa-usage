...
describe("Usage Intelligence view model", () => {
  ...
  it("selects Selected Analysis Window outputs and Fixed Operational Window outputs", () => {
    ...
    expect(viewModel.modelDistribution).toEqual([])
  ...
  it("accepts the shared analytics summary HTTP contract fixture", () => {
    ...
    expect(viewModel.trend[0].label).toBe("2026-05-11")
    expect(viewModel.apiKeys[0].label).toBe("Raw API Key")
