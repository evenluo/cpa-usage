...
describe("fetchEvents", () => {
  it("serializes the shared diagnostic selection and frozen window", () => {
    ...
    })).toBe("/usage/events?range=24h&page_size=10&page=1&provider=claude&model=sonnet&model_alias=sonnet-route&account=auth-1&endpoint=%2Fv1%2Fmessages&status=4xx&request_id=request-42&window_end=2026-09-07T12%3A00%3A00.123456789Z&result=failed")
  })
