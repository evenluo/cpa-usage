...
describe("AttemptPerformance", () => {
  ...
  it("switches the visible comparison between metrics and dimensions", () => {
    ...
    const unknown = screen.getByLabelText("Unknown execution TTFT")
    expect(within(unknown).getByText("0% coverage", { exact: true })).toHaveAttribute("title", "0 of 5 attempts sampled")
